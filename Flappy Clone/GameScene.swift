...
////  Flappy Clone
////
////  Created by Xander Chua on 2/29/20.
...
//        bird.setScale(0.5)
//        bird.position = CGPoint(x: self.frame.width/2 - bird.size.width, y: self.frame.height/2)
//        bird.zPosition = 2
//        bird.physicsBody = SKPhysicsBody(circleOfRadius: bird.size.height / 2)
//        bird.physicsBody!.categoryBitMask = PhysicsCategories.Bird
//        bird.physicsBody!.collisionBitMask = PhysicsCategories.Ground | PhysicsCategories.Wall
//        bird.physicsBody!.contactTestBitMask = PhysicsCategories.Ground | PhysicsCategories.Wall
...
//
//            bird.physicsBody!.velocity = CGVector(dx: 0, dy: 0)
//            bird.physicsBody!.applyImpulse(CGVector(dx: 0, dy: 360))
//        } else
//        {
//            bird.physicsBody!.velocity = CGVector(dx: 0, dy: 0)
//            bird.physicsBody!.applyImpulse(CGVector(dx: 0, dy: 360))
...
//
//        topWall.setScale(2)
//        bottomWall.setScale(2)
//
//        topWall.position = CGPoint(x: self.frame.width - (topWall.size.width*2), y: self.frame.height/2 + 800)
//        bottomWall.position = CGPoint(x: self.frame.width - (bottomWall.size.width*2), y: self.frame.height / 2 - 450)
//
//        topWall.physicsBody = SKPhysicsBody(rectangleOf: topWall.size)
//        topWall.physicsBody!.categoryBitMask = PhysicsCategories.Wall
//        topWall.physicsBody!.collisionBitMask = PhysicsCategories.Bird
//        topWall.physicsBody!.contactTestBitMask = PhysicsCategories.Bird
//        topWall.physicsBody!.affectedByGravity = false
//        topWall.physicsBody!.isDynamic = false
//
//        bottomWall.physicsBody = SKPhysicsBody(rectangleOf: bottomWall.size)
//        bottomWall.physicsBody!.categoryBitMask = PhysicsCategories.Wall
//        bottomWall.physicsBody!.collisionBitMask = PhysicsCategories.Bird
//        bottomWall.physicsBody!.contactTestBitMask = PhysicsCategories.Bird
